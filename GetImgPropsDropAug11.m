...
Ext= cat(1, F.Extent); % of bounding box filled, perhaps combine with mintomaxratio
EqD= cat(1, F.EquivDiameter);
EuN= cat(1, F.EulerNumber);
Perim= cat(1, F.Perimeter);
objnum=[1:gnumAll]';
